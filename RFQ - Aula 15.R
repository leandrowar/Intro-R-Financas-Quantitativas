...
#Aula 15 - Frequencias e Tabelas Cruzadas Parte 2
...
CrossTable(BVSP$VolumeCategorias,BVSP$CorpoCategorias,digits = 2)

CrossTable(BVSP$VolumeCategorias,BVSP$CorpoCategorias,digits = 2 ,expected = T)
